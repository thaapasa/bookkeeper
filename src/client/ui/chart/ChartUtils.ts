import { ChartColumn, ChartData, ChartKeyInfo, ChartKeyType } from './ChartTypes';
...
export function mapChartData<L extends string, K extends ChartKeyType = ChartKeyType>(
  data: ChartData<L, K>,

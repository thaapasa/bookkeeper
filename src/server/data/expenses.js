...
const expenseSelect = "SELECT id, date::DATE, receiver, e.sum::MONEY::NUMERIC, description, source_id, e.user_id, created_by_id, " +
    "group_id, category_id, created, COALESCE(d1.sum, '0.00')::NUMERIC AS user_benefit, COALESCE(d2.sum, '0.00')::NUMERIC AS user_cost, " +
    "(COALESCE(d1.sum, '0.00')::NUMERIC + COALESCE(d2.sum, '0.00')::NUMERIC)::NUMERIC AS user_balance FROM expenses e " +

...
export function determineDivision(expense: ExpenseInput, source: Source): ExpenseDivisionItem[] {
  if (expense.type === 'income') {
    ...
    throw new InvalidInputError('INVALID_INPUT', `Unrecognized expense ${expense.type}`);
  }
}

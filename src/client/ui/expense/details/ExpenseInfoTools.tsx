...
export default class ExpenseInfoTools extends React.Component<RecurrenceInfoProps, {}> {
    ...
    return (
      <ToolContainer>
        {this.props.expense.recurringExpenseId ? null :
          <IconButton title="Muuta toistuvaksi" style={styles.tool} iconStyle={styles.toolIcon}
            onClick={this.createRecurring} ><Repeat color={colors.tool} /></IconButton>}
        <MobileTools>
          <IconButton title="Muokkaa" style={styles.tool} iconStyle={styles.toolIcon}
            onClick={this.onModify}><Edit /></IconButton>
          <IconButton title="Poista" style={styles.tool} iconStyle={styles.toolIcon}
